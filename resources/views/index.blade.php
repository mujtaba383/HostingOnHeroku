...
<main class="main-content">
        ...
        @if($slider->media_img == 'No image found')
            <img src="/assets/images/no-img.jpg" width="1921" height="735" alt="No image found">
        @else
            <img src="/uploads/{{ $slider->media_img }}" width="1921" height="735" alt="{{ $slider->title }}">
        @endif
        </div>
        <!-- Item -->
        @empty
                            ...
                            <div class="item">
                                <div class="product-box">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h5><a href="{{ route('book.detail', [$downloaded_book->slug]) }}">{{ $downloaded_book->title }}</a></h5>
                                        <p>{{ Str::limit($downloaded_book->description, 50, '...')}}</p>
                                        ...
                                        data-id="{{ $downloaded_book->id }}"
                                        data-image="/uploads/{{ $downloaded_book->book_img }}"
                                        data-title="{{ $downloaded_book->title }}"
                                        data-price="{{ $downloaded_book->price }}"
                                        >Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="recomend-slider">
                    ...
                    <div class="item">
                        ...
                        <img src="/assets/images/no-img.jpg" width="109" height="150" alt="No record found">
                        @else
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="sidebar">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ route('category.detail', [$category->slug]) }}">{{ $category->title }}</a></li>
                                    @empty
                                        <div class="alert alert-danger">No record found!</div>
                                    @endforelse
                                </ul>
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="collection">
                                ...
                                <div class="collection-content">
                                    <ul>
                                        @forelse($book_collections as $book_collection)
                                        <li>
                                            <div class="s-product">
                                                <div class="s-product-img">
                                                    @if($book_collection->book_img == 'No image found')
                                                        <img src="/assets/images/no-img.jpg" width="145" height="209" alt="No image found">
                                                    @else
                                                        <img src="/uploads/{{ $book_collection->book_img }}" width="145" height="209" alt="{{ $book_collection->title }}">
                                                    @endif
                                                    <div class="s-product-hover"></div>
                                                </div>
                                                <h6><a href="#">{{ Str::limit($book_collection->title, 15, '...') }}</a></h6>
                                                <span>{{ Str::limit($book_collection->author->title, 15, '...') }}</span>
                                            </div>
                                        </li>
                                        @empty
                                            <div class="alert alert-danger">No record found!</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-12">
                        <div class="aurthor-img">
                            ...
                            <img src="/assets/images/no-img.jpg" width="243" height="344" alt="No image found">
                            @else
                                ...
                                <li id="1985">
                                    <div class="text-box">
                                        ...
                                        <ul class="s-related-products">
                                            @forelse($author_feature->author_books as $key => $author_book)
                                            @if($key < 3)
                                            <li>
                                                @if($author_book->book_img == 'No image found' )
                                                    <img src="/assets/images/no-img.jpg" width="89" height="119" alt="No image found">
                                                @else
