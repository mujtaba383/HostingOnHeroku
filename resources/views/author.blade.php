					...
					<div class="col-lg-9 col-md-8 col-xs-12">
						...
						<div class="authors-filter">
							<ul>
								...
								<li><a class="{{ Request::get('letter') === strtolower($letter) ? 'selected' : '' }}" href="author?letter={{ strtolower($letter) }}">{{ $letter }}</a></li>
							 	@endforeach
							</ul>
						</div>
						<!-- Author Filter -->
					...
					<aside class="col-lg-3 col-md-4 col-xs-12">
						...
						<div class="aside-widget">
							...
							<ul class="s-arthor-list">
								@forelse($authorFeatures as $authorFeature)
								<li>	
									<div class="s-arthor-wighet">
										<div class="s-arthor-img">
											@if($authorFeature->author_img == 'No image found')
											<img src="/assets/images/no-img.jpg" width="45" height="45" alt="No image found">
											@else
											<img src="/uploads/{{ $authorFeature->author_img }}" width="45" height="45" alt="{{ $authorFeature->title }}">
											@endif
											<div class="overlay">
												<a class="position-center-center" href="#">+</a>
											</div>
							...
							<ul class="books-year-list">
								...
								<li>	
									<div class="books-post-widget">
										...
										<img src="/assets/images/no-img.jpg" width="54" height="73" alt="No iamge found">
										@else
								...
								@empty
										<div class="alert alert-danger">Noo record found!</div>
								@endforelse
							</ul>
						</div>
						<!-- Aside Widget -->
