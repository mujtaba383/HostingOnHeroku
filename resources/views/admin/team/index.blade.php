...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">
                <a id="activeAllStatus" url="{{ route('status_active_team') }}" class="btn btn-danger btn-xm" data-toggle="tooltip" title="Active Selected"><i class="fa fa-eye"></i></a>
                <a id="deactiveAllStatus" url="{{ route('status_deactive_team') }}" class="btn btn-danger btn-xm" data-toggle="tooltip" title="Deactive Selected"><i class="fa fa-eye-slash"></i></a>
                <a id="delete_all" url="{{ route('delete_all_team') }}" class="btn btn-danger btn-xm" data-toggle="tooltip" title="Delete All"><i class="fa fa-trash"></i></a>
        ...
        <div class="box-body">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td><input type="checkbox" name="statusAll[]" id="" value="{{ $team->id }}" class="checkSingle"></td>
                    <td>{{ $team->fullname }}</td>
                    <td>{{ $team->designation }}</td>
                    <td>@if($team->team_img == 'No image found')
                        <img src="/assets/admin/dist/img/no-img.jpg" width="80" height="80"  alt="No image found" class="img-thumbnail">
                        @else
                        <img src="/uploads/{{ $team->team_img }}" width="80" height="80"  alt="{{ $team->fullname }}" class="img-thumbnail">
                        @endif
                    </td>
                    <td>
