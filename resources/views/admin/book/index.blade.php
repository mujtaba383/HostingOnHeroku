...
<section class="content">
     ...
     <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"> 
                    <a id="activeAllStatus" url="{{ route('status_active_book') }}" class="btn btn-danger btn-xm" data-toggle="tooltip" title="Active Selected"><i class="fa fa-eye"></i></a>
                    <a id="deactiveAllStatus" url="{{ route('status_deactive_book') }}" class="btn btn-danger btn-xm" data-toggle="tooltip" title="Deactive Selected"><i class="fa fa-eye-slash"></i></a>
                    <a id="delete_all" url="{{ route('delete_all_book') }}" class="btn btn-danger btn-xm" data-toggle="tooltip" title="Delete All"><i class="fa fa-trash"></i></a>
                    <a href="/admin/book/create" class="btn btn-default btn-xm"  data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i></a>
              </h3>
              <div class="box-tools">
            ...
            <div class="box-body">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <td><input type="checkbox" name="statusAll[]" id="" value="{{ $book->id }}" class="checkSingle"></td>
                  <td>{{ $book->title }}</td>
                  <td>{{ $book->author->title }}</td>
                  <td>{{ $book->category->title }}</td>
                  <td>@if($book->book_img == 'No image found')
                    <img src="/assets/admin/dist/img/no-img.jpg" width="80" height="80" alt="No image found" class="img-thumbnail">
                    @else
                    <img src="/uploads/{{ $book->book_img }}" width="80" height="80" alt="{{ $book->title }}" class="img-thumbnail">
                    @endif
                  </td>
                  <td>
